...
class PatientListWindow(QWidget):
    ...
    def update_patient_list(self):
        ...
        for patient in patient_data:
            id=patient["id"]
            item_text = f'Name: {patient["Name"]}, Age: {patient["Age"]}, Sessions: {patient["Sessions"]}'
            ...
            btn_start_session = QPushButton("Start Session")
            btn_start_session.clicked.connect(lambda _, name=patient["Name"]: self.startSession.emit(name))
