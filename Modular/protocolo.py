...
def main():
    ...
    try:
        ...
        stimulation_thread = threading.Thread(target=Stimulation_Sequence, args=(board_shim, serial_port, n_channel, b, a, total_duration, number_of_intervals, stop_flag))
