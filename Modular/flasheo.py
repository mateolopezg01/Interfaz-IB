...
class NeurobackApp(QWidget):
    ...
    def show_patient_list(self): #crear una ventana lista pacientes y definir las conexiones
        ...
        self.patient_lista_window = PatientListWindow()
        ...
        self.patient_lista_window.show()
...
class PatientListWindow(QWidget):
    ...
    def add_list_buttons(self):#añadir botones
        ...
        for patient in patient_data:
            ...
            btn_see_data.clicked.connect(self.get_patient_data(id))

            btn_start_session = QPushButton("Start Session")
            btn_start_session.clicked.connect(self.open_session_window(id))

            btn_remove_patient = QPushButton("Remove Patient")
            btn_remove_patient.clicked.connect(self.remove_patient(id))
...
#     def start(self):
#         # SE ESTABLECE COMUNICACIÓN CON CYTON
